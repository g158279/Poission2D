...
{
    void gauss_quadrature_2d(size_t n, std::vector<Eigen::Vector2d>& points, std::vector<double>& weights) {
    ...
    for (size_t i = 0; i < n; ++i) {
        ...
        for (size_t j = 0; j < n; ++j) {
            ...
            points.emplace_back(Eigen::Vector2d(s, t));
            weights.push_back(w_s * w_t);
        }
    }
}
